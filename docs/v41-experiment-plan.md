...
로드 자체도 타이밍할 가치가 있다. ~~실측 지속 읽기 속도가 약 6 GB/s인 드라이브에서 347 GB를 읽는 것은 약 1분의 하한선이며,~~ 2026-09-23 정정: 읽기 6 GB/s는 원 측정이 없다 — 로그에 있는 드라이브 수치는 쓰기 5.74–5.85 GB/s뿐이다. V4.1 9샤드를 MAP_POPULATE로 한 번 읽은 실측은 1.33 GB/s(474 GB에 356 s, [09-23#v41-oracle-dump](../log/2026-09-23.md#v41-oracle-dump))였다. 그보다 훨씬 느린 로드는 파일이 어떻게 읽히는지에 대한 무언가를 말해준다 — 그 실측에서 적재는 한 줄기로 돌았다(loadavg 1–2).
