...
| 2026-09-15 | [GLM-5.3-Flash: first numbers](log/2026-09-15-glm-5.3-flash-first-run.md) | second MoE family on the same probes, ik main the day after its port merged: PPL 2.04, decode 17.0 → 18.7 tok/s with ten expert layers on the cards (about 1 % a layer, half what the expert bytes predict — not bandwidth-bound), prefill 353 tok/s; in progress |
