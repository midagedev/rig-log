...
3090은 부하 중 버스에서 떨어진다(`Xid 79`). NCCL DDP로 133초 만에 재현되고 양 카드를 250 W로 묶으면 같은 DDP가 900초 동안 깨끗하지만, 이것은 동작하는 설정이지 원인 규명이 아니다([재현](log/2026-09-18.md#b-the-fault-reproduced)). 2026-09-22에 하루 두 번 떨어져서 그날부터 시간 측정은 A6000에서 하고, 3090은 게이트·빌드용으로 300 W 캡을 걸어 쓴다([기록](log/2026-09-22-g-the-3090-fell-twice-so-the-clock-moved-to-the-a6000.md)).
